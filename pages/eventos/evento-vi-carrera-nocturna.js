  ...
  <div>
    ...
    <div className="main-info container">
      <h1 className="reglamento-h1">
        VI carrera nocturna por el centro peninsular
      </h1>
      <h3 className="reglamento-data">4 de Agosto de 2018</h3>
      ...
      <div className="reglamento">
        ...
        <p>
          El sábado 4 de Agosto de 2018 a partir de las 20:00h (Niños) 21:30h
          (Adultos) se celebrara la VI Edición de la carrera nocturna de Pinto,
        ...
        <p>Viernes dia 3 de 11:00 a 13:30 h Y de 16:00h a 20:00h</p>
        <p>Sabado dia 4 de 11:00 a 14:00h</p>
        <p>
          Y a partir de las 18,00 en el polideportivo Alberto Contador
          presentando el justificante de inscripción o de pago de la persona
          inscrita, hasta 30´minutos antes de la salida de la carrera.
        </p>
        <p>
        ...
        <p>
          ...
          Alberto Contador Calle Isabel la Católica n1
        </p>
        <br />
